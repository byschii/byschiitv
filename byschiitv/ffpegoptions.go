...
func FfmpegLightCommand(videoPath string, rtmpURL string) []string {
	...
	sliceCommand := []string{
		"-re",                  // read at native frame rate
		"-c:v", "h264_v4l2m2m", // video codec
		"-b:v", "1000k", "-maxrate", "1200k", "-bufsize 2000k", // video bitrate
		"-vf", "scale=854:480:flags=fast_bilinear,fps=25,format=yuv420p", // scale video to 480p
		"-g", "50", "-keyint_min", "50", // GOP size
		"-num_output_buffers", "32", "-num_capture_buffers", "16",
		"-c:a", "aac", "-b:a", "64k", "-ar", "44100", "-ac", "2", // audio codec
		rtmpURL}
